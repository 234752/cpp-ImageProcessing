...
int main() {
    CImg<unsigned char> image("..\\..\\img\\color_24bit\\lenac_small.bmp"); // create the image from a file (must exist in the working dir)
    ...
    image.save_bmp("..\\..\\img\\color_24bit\\out.bmp"); // save the modified image to a file
    return 0;
}